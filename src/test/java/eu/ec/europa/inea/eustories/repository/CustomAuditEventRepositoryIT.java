...
import eu.ec.europa.inea.eustories.config.audit.AuditEventConverter;
import eu.ec.europa.inea.eustories.domain.PersistentAuditEvent;
...
import static eu.ec.europa.inea.eustories.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
